...
add_xls = common.get_xls("loan.xlsx", "querySign")  #读取测试用例
...
class TestQuerySign(unittest.TestCase):
    def setParameters(self,case_name, method,  externalUserId, merchantId,productCode, resultCode, success):
        """
        set params
        :param case_name:
        :param method:
