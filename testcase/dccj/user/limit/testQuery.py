...
add_xls = common.get_xls("loan.xlsx", "query")  #读取测试用例
...
class TestQuery(unittest.TestCase):
    def setParameters(self, case_name, method, productCode,externalUserId,merchantId, resultCode, success):
        """
        set params
        :param case_name:
        :param method:
    ...
    def testQuery(self):
        ...
        params.update(productCode=self.productCode)
    ...
    def tearDown(self):
        ...
        try:
            ...
            WeChatClient.sendmsg("DCCJ-好美意额度查询用例","\nDCCJ-好美意额度查询用例"+"\n用例名："+self.case_name+"\n响应时间(ms):"+str(self.time))
        except KeyError:
